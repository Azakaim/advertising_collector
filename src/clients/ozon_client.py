...
class OzonClient(BaseRateLimitedHttpClient):
    ...
    async def fetch_advertising_ids(self, **kwargs) -> Optional[Any]:
        req = self.request("GET", self.ads_ids_url, **kwargs)

    async def fetch_advertising_company_statistics(self, **kwargs) -> Optional[Any]:
        ...
